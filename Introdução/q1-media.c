...
****/
int Media(int valor1, int valor2){          // A Função está definida como int e recebendo valores inteiros, ou seja, mesmo que o usuario entre com valores float, como 8.0
    int soma = valor1 + valor2;             // e 9.0, esperando 8.5 como resposta, a divisão sera feita com valroes inteiros, resultando uma resposta inteira.
    return soma / 2;
}

// Versão Função Media Funcional:

float CorrectMedia( float valor1, float valor2){
